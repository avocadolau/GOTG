...
void main()
{
    ...
    hologramTexCoords.y -=  u_Speed * u_LifeTime;

    vec4 hologramColor = texture(u_HologramTexture,hologramTexCoords);

    hologramColor = vec4(1.0,1.0,1.0,hologramColor.r);

    hologramColor *= u_HologramColor;
