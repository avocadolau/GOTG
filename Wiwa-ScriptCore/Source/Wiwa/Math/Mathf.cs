...
namespace Wiwa
{
    ...
    {
        public static readonly Quaternion identityQuaternion = new Quaternion(0F, 0F, 0F, 1F);
        ...
        public static Vector3 CalculateRight(ref Transform3D t3d)
        {
            ...
            right.x = RadToDeg(right.x);
            right.y = RadToDeg(right.y);
            right.z = RadToDeg(right.z);
